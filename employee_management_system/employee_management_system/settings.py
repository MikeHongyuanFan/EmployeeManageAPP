...
INSTALLED_APPS = [
    ...
    'leave_system.apps.LeaveSystemConfig',
    'wfh_system.apps.WfhSystemConfig',
...
MIDDLEWARE = [
    ...
    'employee_management_system.middleware.CorsMiddleware',
...
DEFAULT_FROM_EMAIL = 'noreply@employeemanagementsystem.com'

# CORS settings - most permissive for development
